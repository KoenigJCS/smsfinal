defmodule SmsfinalWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SmsfinalWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SmsfinalWeb.Gettext, "errors", msg, opts)
    end
  end
