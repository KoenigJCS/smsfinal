defmodule SmsfinalWeb.ProductLive.Index do
  ...
  @impl true
  def handle_info({SmsfinalWeb.ProductLive.FormComponent, {:saved, product}}, socket) do
    {:noreply, stream_insert(socket, :products, product |> Repo.preload(:stores, force: true))}
  end
