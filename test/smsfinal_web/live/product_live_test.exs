defmodule SmsfinalWeb.ProductLiveTest do
  use SmsfinalWeb.ConnCase

  import Phoenix.LiveViewTest
  import Smsfinal.CompanyFixtures

  @create_attrs %{inv_count: 42, name: "some name", retail_price: 120.5, vendor: "some vendor", whole_price: 120.5}
